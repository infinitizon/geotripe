...
START TRANSACTION;
USE `geotripe`;
INSERT INTO `geotripe`.`AuthView` (`AuthView_Id`, `Name`, `ViewPath`, `description`) VALUES (13072016, 'Dashboard', '/dashboard', 'Shows the dashboard on login');
INSERT INTO `geotripe`.`AuthView` (`AuthView_Id`, `Name`, `ViewPath`, `description`) VALUES (13072017, 'Quotes', '/quotes', 'Monitors Quote Lifecycle');
INSERT INTO `geotripe`.`AuthView` (`AuthView_Id`, `Name`, `ViewPath`, `description`) VALUES (13072018, 'Setup', '/setup', 'Admin Setup page');
